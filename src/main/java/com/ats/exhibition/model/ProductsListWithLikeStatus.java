...
@Entity
public class ProductsListWithLikeStatus {
	...
	public String toString() {
		return "ProductsListWithLikeStatus [prodId=" + prodId + ", exhId=" + exhId + ", prodName=" + prodName
				+ ", prodDesc=" + prodDesc + ", prodSpecification=" + prodSpecification + ", prodExperty=" + prodExperty
				+ ", prodImage1=" + prodImage1 + ", prodImage2=" + prodImage2 + ", prodImage3=" + prodImage3
				+ ", isUsed=" + isUsed + ", likeStatus=" + likeStatus + "]";
	}
