...
public interface GetEventsListRepository extends JpaRepository<GetEventsList, Integer> {
	...
	@Query(value = "SELECT e.event_id,e.org_id,o.org_name,c.company_type_name,e.event_name,e.event_from_date,"
			...
			+ " from m_events e,t_visitor_event ,m_location l,m_organiser o,m_company c where e.is_used=1 and "
			+ "l.location_id=e.location_id and c.company_type_id=e.company_type_id and o.org_id=e.org_id group by e.event_id", nativeQuery = true)
