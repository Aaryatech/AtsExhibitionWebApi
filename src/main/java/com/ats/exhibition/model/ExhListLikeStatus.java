...
@Entity
public class ExhListLikeStatus {
	...
	public String toString() {
		return "ExhListLikeStatus [exhId=" + exhId + ", orgId=" + orgId + ", orgName=" + orgName + ", exhName="
				...
				+ ", locationName=" + locationName + ", companyTypeName=" + companyTypeName + ", likeStatus="
				+ likeStatus + "]";
	}
