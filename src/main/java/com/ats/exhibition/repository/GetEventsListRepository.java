...
public interface GetEventsListRepository extends JpaRepository<GetEventsList, Integer> {
	...
	@Query(value = "SELECT e.event_id,e.org_id,o.org_name,c.company_type_name,e.event_name,e.event_from_date,e.event_to_date,"
			...
			+ " where t_visitor_event.visitor_id=:visitorId and e.event_id=t_visitor_event.event_id),0)as subscribe_status from m_events e,"
			+ "t_visitor_event ,m_location l,m_organiser o,m_company c where e.is_used=1 and e.event_id IN(select event_id from"
			+ " t_visitor_event where t_visitor_event.visitor_id=:visitorId) and l.location_id=e.location_id and c.company_type_id=e.company_type_id "
			+ "and o.org_id=e.org_id group by e.event_id", nativeQuery = true)
	List<GetEventsList> getEventList(@Param("visitorId") int visitorId);
	...
	@Query(value = "SELECT e.event_id,e.org_id,o.org_name,c.company_type_name,e.event_name,e.event_from_date,"
			...
			+ " from m_events e,t_visitor_event ,m_location l,m_organiser o,m_company c where e.is_used=1 and e.event_id IN(select event_id from t_visitor_event where t_visitor_event.visitor_id=1)"
			+ " and "
			+ "l.location_id=e.location_id and c.company_type_id=e.company_type_id and o.org_id=e.org_id and e.company_type_id"
			+ " In(:companyTypeIdList)  group by e.event_id", nativeQuery = true)
	...
	@Query(value = "SELECT e.event_id,e.org_id,o.org_name,c.company_type_name,e.event_name,e.event_from_date,"
			...
			+ "e.person2_email_id,e.is_used,e.location_id,l.location_name,e.company_type_id,coalesce((select subscribe_status"
			+ "from t_visitor_event where t_visitor_event.visitor_id=:visitorId and e.event_id=t_visitor_event.event_id),0)as subscribe_status"
			+ " from m_events e,t_visitor_event ,m_location l,m_organiser o,m_company c where e.is_used=1  and e.event_id IN(select event_id from t_visitor_event where t_visitor_event.visitor_id=1)and "
